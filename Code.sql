...
UPDATE actor 
   ...
   ELSE first_name END WHERE first_name IN('HARPO', 'GROUCHO');
...
WHERE
	payment.payment_date >='2005-08-01T00:00:00:000' AND
	payment.payment_date <= '2005-08-31T23:59:59.999'
...
FROM customer cust
INNER JOIN address ON address.address_id = cust.address_id
